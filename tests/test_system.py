...
from src.core.pdf_to_graph import PDFToGraphPipeline
from src.core.graph_manager import GraphManager
from config.schemas import create_legal_document_schema
...
def test_full_workflow():
    ...
    try:
        pipeline = PDFToGraphPipeline(schema, graph)

        # For the sample file, we'll use a different approach
